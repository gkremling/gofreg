##' @title Generalized linear model with Poisson distribution
##' @description This class represents a generalized linear model with Poisson
...
##' @param params model parameters to use (`list()` with tag beta),
...
##'
##' # Create an instance of PoissonGLM
##' model <- PoissonGLM$new()
##'
##' # Fit a Poisson GLM to the cars dataset
