...
This is a basic example which shows you how to fit a parametric regression
model (in this case a generalized linear model with normal distribution) to
given data and afterwards perform a goodness-of-fit test (in this case using
the conditional Kolmogorov test statistic of the marginal distribution of $Y$ 
defined in Kremling & Dikta (2024)). As an example dataset we use
`datasets::cars`.
